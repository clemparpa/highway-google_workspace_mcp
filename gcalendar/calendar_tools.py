...
async def get_events(
    ...
    Args:
        ...
        time_min (Optional[str]): The start of the time range (inclusive) in RFC3339 format (e.g., '2025-05-12T10:00:00Z' or '2025-05-12'). If omitted, defaults to the current time.
